				...
				<button
					...
					<div className="flex items-center gap-4">
						...
						<div className="text-left">
							<div className={`font-bold text-lg ${vpnEnabled ? "text-green-400" : "text-white"}`}>
								...
								<div className="w-full">
									...
									{scanMode ? (
										<div className="flex justify-between items-center mt-1.5 text-[10px] md:text-xs font-mono text-gray-400 bg-black/30 p-1.5 rounded">
											...
											<span className={net.security === "OPEN" ? "text-red-400" : "text-green-400"}>
												{net.security}
											</span>
										</div>
									) : (
				...
				<AnimatePresence>
					{feedback === "error" && (
						<motion.div
							...
							<p className="text-gray-300 mb-6 leading-relaxed">
								...
								<br />
								<span className="text-sm text-gray-500 mt-2 block">Всегда включай VPN в кафе.</span>
							</p>
							<button
					...
					{feedback === "warning" && (
						<motion.div
							...
							<button
								onClick={() => onComplete()}
								className="bg-gray-700 text-white px-8 py-2 rounded-full hover:bg-gray-600 transition-colors">
								Продолжить
							</button>
						</motion.div>
					)}
