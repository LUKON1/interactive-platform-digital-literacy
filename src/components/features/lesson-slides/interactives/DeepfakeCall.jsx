...
export const DeepfakeCall = ({ data, onComplete, onPrevious, canGoPrevious, isCompleted }) => {
	...
	return (
		<div className="w-full max-w-sm mx-auto h-162.5 flex flex-col bg-black rounded-[3rem] overflow-hidden shadow-2xl relative border-8 border-gray-800">
			...
			{/* Navigation Overlay - only show when call ended */}
			{isCompleted && status === "ended" && (
				<div className="absolute inset-0 bg-black/80 backdrop-blur-sm flex items-end pb-8 z-30 pointer-events-none">
