...
import { Timer, Smartphone, CheckCircle, RefreshCw, ShieldCheck } from "lucide-react";

export const TotpSimulator = ({ onComplete }) => {
	...
	return (
		<div className="flex flex-col md:flex-row items-center justify-center gap-12 w-full max-w-4xl mx-auto h-full p-4">
			{/* Virtual Phone */}
			<motion.div
