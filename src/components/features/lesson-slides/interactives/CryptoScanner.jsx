...
export const CryptoScanner = ({ onComplete, onPrevious, canGoPrevious, isCompleted }) => {
	const [selectedIndex, setSelectedIndex] = useState(null);
	const [complete, setComplete] = useState(isCompleted || false);
	...
	return (
		<div className="flex flex-col h-full w-full max-w-md mx-auto">
			<div className="flex-1 bg-slate-900 border border-slate-700 rounded-xl overflow-hidden shadow-2xl">
			...
			<InteractiveNavigation
				...
				lockedMessage="Найдите правильный контракт"
			/>
		</div>
	);
};
